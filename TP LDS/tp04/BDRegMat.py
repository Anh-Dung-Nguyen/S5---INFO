...
class BDRegMat:
    def __init__(self, out, nom='defaut.db'):
        ...
        try:
            ...
            self.cur.execute('PRAGMA foreign_keys = ON') # --> cette ligne est essentielle pour garantir que les relations entre les tables sont respectées et que les données de la base restent cohérentes.
